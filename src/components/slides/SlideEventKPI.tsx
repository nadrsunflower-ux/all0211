...
export default function SlideEventKPI() {
  return (
    <div className="w-full h-full bg-white flex flex-col px-10 py-7 relative overflow-hidden">
      ...
      >
        ...
        <span className="text-pink-400 text-[10px]">[3] KPI</span>
      </motion.div>
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="relative w-full max-w-[90%] h-full rounded-2xl overflow-hidden border border-pink-100 shadow-lg shadow-pink-100/50">
          <Image
            src="/images/b2.png"
            alt="이벤트팀 분기별 KPI"
            fill
